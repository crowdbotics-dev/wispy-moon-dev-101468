...
## Project Structure
    ...
    ├── wispy_moon_dev_101468  # Django project configurations
...
1. Clone this repo and `cd wispy_moon_dev_101468`
...
2. Clone this repo and `cd wispy_moon_dev_101468`
